namespace HowManyDo.Admin
{
	partial class Admin_Form_Write
	{
		...
		private void InitializeComponent()
		{
			...
			this.AWrtie_Pic_SelectedPic = new System.Windows.Forms.PictureBox();
			this.AWrtie_Btn_Send = new System.Windows.Forms.Button();
			this.AWrite_Btn_Temp = new System.Windows.Forms.Button();
			this.AWrite_Btn_Cancel = new System.Windows.Forms.Button();
			this.AWrite_Listb_Name = new System.Windows.Forms.ListBox();
			((System.ComponentModel.ISupportInitialize)(this.AWrtie_Pic_SelectedPic)).BeginInit();
			this.SuspendLayout();
			// 
			// AWrite_TextB_Body
			// 
			...
			// 
			this.AWrtie_Pic_SelectedPic.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.AWrtie_Pic_SelectedPic.Location = new System.Drawing.Point(348, 124);
			this.AWrtie_Pic_SelectedPic.Name = "AWrtie_Pic_SelectedPic";
			this.AWrtie_Pic_SelectedPic.Size = new System.Drawing.Size(138, 90);
			this.AWrtie_Pic_SelectedPic.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
			this.AWrtie_Pic_SelectedPic.TabIndex = 4;
			this.AWrtie_Pic_SelectedPic.TabStop = false;
			// 
			// AWrtie_Btn_Send
			// 
			...
			this.AWrtie_Btn_Send.Location = new System.Drawing.Point(348, 245);
			...
			// AWrite_Btn_Temp
			// 
			this.AWrite_Btn_Temp.Font = new System.Drawing.Font("서울남산체 M", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
			this.AWrite_Btn_Temp.Location = new System.Drawing.Point(348, 315);
			this.AWrite_Btn_Temp.Name = "AWrite_Btn_Temp";
			this.AWrite_Btn_Temp.Size = new System.Drawing.Size(138, 53);
			...
			// AWrite_Listb_Name
			// 
			this.AWrite_Listb_Name.FormattingEnabled = true;
			this.AWrite_Listb_Name.ItemHeight = 12;
			this.AWrite_Listb_Name.Location = new System.Drawing.Point(348, 43);
			this.AWrite_Listb_Name.Name = "AWrite_Listb_Name";
			this.AWrite_Listb_Name.Size = new System.Drawing.Size(138, 40);
			this.AWrite_Listb_Name.TabIndex = 8;
			// 
			// Admin_Form_Write
			// 
			...
			this.Controls.Add(this.AWrite_Listb_Name);
			this.Controls.Add(this.AWrite_Btn_Cancel);
			this.Controls.Add(this.AWrite_Btn_Temp);
			this.Controls.Add(this.AWrtie_Btn_Send);
			this.Controls.Add(this.AWrtie_Pic_SelectedPic);
			...
			this.Text = "글작성";
			((System.ComponentModel.ISupportInitialize)(this.AWrtie_Pic_SelectedPic)).EndInit();
		...
		private System.Windows.Forms.PictureBox AWrtie_Pic_SelectedPic;
		private System.Windows.Forms.Button AWrtie_Btn_Send;
		private System.Windows.Forms.Button AWrite_Btn_Temp;
		private System.Windows.Forms.Button AWrite_Btn_Cancel;
		private System.Windows.Forms.ListBox AWrite_Listb_Name;
	}
}